class NoItemSelected extends Error {
  constructor(message) {
    super(message)
    this.name = 'NoItemSelected'
  }
}
...
module.exports = {NoItemSelected, ItemDoesntExist, PlayerDoesntHaveItem, ItemIsUnusable, ItemIsUnreadable, EmptyInventory, ItemIsNotPresent, ItemIsNotTabkeable}
