const puzzleList = [
  {
    ...
    solved: 'You successfully unlocked the door.',
    answer: '12345',
  ...
  },
  {
    ...
    solved: 'The amulet resonates with the shadows, aligning with the theme of the puzzle. It reveals the hidden passage to a mysterious room.',
    answer: '0981',
  ...
  },
  {
    ...
    solved: 'The portal trembles and then opens, revealing the path to victory!',
    answer: 'In shadows bound, secrets unchain. Speak the words to unveil the path.',
